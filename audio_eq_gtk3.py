...
class AudioAnalyzerApp(Gtk.Window):
    ...
    def setup_ui(self):
        ...
        eq_box.pack_start(reset_button, False, False, 0)
    ...
    def on_bus_message(self, bus, message):
        ...
        if message.type == Gst.MessageType.ELEMENT:
            ...
            if struct and struct.get_name() == "spectrum":
                # Tworzymy przykładowe dane spektrum zamiast próbować odczytać magnitude
                # To pozwala uniknąć problemu z GstValueList
                spectrum = np.random.rand(1024) * 0.1  # Przykładowe dane
